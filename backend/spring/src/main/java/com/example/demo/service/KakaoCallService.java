...
public class KakaoCallService {
    ...
    public KakaoCallService(
            ...
            @Value("${coolsms.templeteid}")String templeteId) {
    ...
    public SingleMessageSentResponse sendOneAta(String userPhoneNumber, Integer waitingTeam, String storeName, Integer minutesToAdd) {
        ...
        variables.put("#{minutesToAdd}", Integer.toString(minutesToAdd));
