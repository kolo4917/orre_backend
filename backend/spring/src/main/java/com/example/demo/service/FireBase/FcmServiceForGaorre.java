...
@Service
public class FcmServiceForGaorre {

    // Firebase FCM 메시지 전송 API URL
    private static final String API_URL = "https://fcm.googleapis.com/v1/projects/gaorre-97b39/messages:send";
    ...
    private String getAccessToken() throws IOException {
        ...
        String firebaseConfigPath = "firebase/firebase_service_key_for_gaorre.json";
